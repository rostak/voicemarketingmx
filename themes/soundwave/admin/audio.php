...
function audio_type() {
    $imagepath = get_template_directory_uri() . '/images/posticon/';
    $labels    = array(
...
<label style="display:block;padding:2px;">' . __('Tipo de Audio', 'clubber') . ': </label>
<input style="width:220px;" name="audio_genre" value="' . $genre . '">
Escriba Tipo de audio.
</div>';
    echo '<div style="padding-top:10px;">
<label style="display:block;padding:2px;">' . __('Fecha de Audio (mm/dd/yy)', 'clubber') . ': </label>
<input style="width:220px;" name="release_date" id="event-date" value="' . $date . '">
Click a la fecha en que se realizo el audio.
</div>';
    echo '<div style="padding-top:10px;">
<label style="display:block;padding:2px;">' . __('Locutor', 'clubber') . ': </label>
<input style="width:220px;" name="audio_artist" value="' . $artist . '">
Esceiba Nombre del Locutor.
</div>';
    echo '<div style="padding-top:10px;">
