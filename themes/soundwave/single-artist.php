...
if ($name != null) {
    echo '	  
            <div class="evsng-info-in">
               <div class="atsng-cell">Birth name</div>
...
if ($place != null) {
    echo '
            <div class="evsng-info-in">                                     
               <div class="atsng-cell">Birthplace</div>
...
if ($genres != null) {
    echo '
            <div class="evsng-info-in">                                     
               <div class="atsng-cell">Servicios</div>
...
if ($active != null) {
    echo '
            <div class="evsng-info-in">                                     
               <div class="atsng-cell">Years active</div>
...
if ($website != null) {
    echo '
            <div class="evsng-info-in">                                     
               <div class="atsng-cell">Website</div>
