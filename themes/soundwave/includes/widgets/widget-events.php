...
?>
   ...
   <div class="evwdg">                                                          
      <div class="evwdg-data">
         <div class="evwdg-day"><?php echo $pretty_date_d; ?></div>
         <div class="evwdg-month"><?php echo $pretty_date_M; ?></div>
         <div class="evwdg-year"><?php echo $pretty_date_yy; ?></div>
      </div><!-- .evwdg-data-->
...
if (get_post_meta($post->ID, 'event_disable', true) == 'no') {
    if ($ev_text) {
	 ...
	 if (get_post_meta($post->ID, 'event_out', true) == 'yes') {
            echo '
	  <div class="evwdg-out"><p>Sold Out</p></div>';
        } elseif (get_post_meta($post->ID, 'event_cancel', true) == 'yes') {
            echo '
	  <div class="evwdg-out"><p>Canceled</p></div>';
        }elseif (get_post_meta($post->ID, 'event_free', true) == 'yes') { 
            echo '
	  <div class="evwdg-out"><p>Free Entry</p></div>';
        } else {
            echo '
	  <div class="evwdg-tickets"><a href="' . $event_ticket . '" target="_blank">Buy Tickets</a></div>';
        }
