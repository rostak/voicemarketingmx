	...
	if (get_post_meta($post->ID, 'event_disable', true) == 'no') {
        if ($ev_text) {    
            ...
            if (get_post_meta($post->ID, 'event_out', true) == 'yes') {
                $items_src .= '
                        <div class="ev1shr-cancel">Sold Out</div>';
            } elseif (get_post_meta($post->ID, 'event_cancel', true) == 'yes') {
                $items_src .= '
                        <div class="ev1shr-cancel">Canceled</div>';
            } elseif (get_post_meta($post->ID, 'event_free', true) == 'yes') {
                $items_src .= '
                        <div class="ev1shr-cancel">Free Entry</div>';
            } else {
                $items_src .= '
                        <div class="ev1shr-tickets"><a href="' . $event_ticket . '" >Buy Tickets</a></div><!-- end #event-tickets -->';
            }
        }
	}
        $items_src .= '	
        ...
        $items_src .= '
               ...
               <div class="ev1shr-data">
                  <div class="ev1shr-day">' . $pretty_date_d . ' ' . $pretty_date_M . '</div>
                  <div class="ev1shr-week">' . $pretty_date_w . '</div>
               </div>
		    </div><!-- end .ev1shr-info -->
         </div><!-- end .ev1shr-col -->     ';
    endwhile;
   ...
   <div class="home-shr clearfix">
        ...
        $items_src .= '
         <div class="ev2shr-col">       
            <div class="ev2shr-data">
               <div class="ev2shr-day">' . $pretty_date_d . '</div>
               <div class="ev2shr-month">' . $pretty_date_M . '</div>
               <div class="ev2shr-year">' . $pretty_date_yy . '</div>
            </div><!-- end .ev2shr-data -->                
	...
	if (get_post_meta($post->ID, 'event_disable', true) == 'no') {
        if ($ev_text) {
            ...
            if (get_post_meta($post->ID, 'event_out', true) == 'yes') {
                $items_src .= '
            <div class="ev2shr-cancel">Sold Out</div>';
            } elseif (get_post_meta($post->ID, 'event_cancel', true) == 'yes') {
                $items_src .= '
            <div class="ev2shr-cancel">Canceled</div>';
            } elseif (get_post_meta($post->ID, 'event_free', true) == 'yes') {
                $items_src .= '
            <div class="ev2shr-cancel">Free Entry</div>';
            } else {
                $items_src .= '
            <div class="ev2shr-tickets"><a href="' . $event_ticket . '" >Buy Tickets</a></div>';
            }
        }
	}
        $items_src .= '    
            <div class="ev2shr-week">' . $pretty_date_w . '</div>
         </div><!-- end .ev2shr-col -->';
    endwhile;
    $items_src .= '
      </div><!-- end .home-width -->
