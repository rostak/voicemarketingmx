    ...
    while ($wp_query->have_posts()):
        ...
        echo '
            <div class="bl1page-info">
               ...
               <p class="bl1page-comment"><a href="' . get_comments_link() . '" target="_blank" class="no-ajax">';
        echo comments_number('No Comments', '1 Comment', '% Comments');        
        echo '</a></p> 
            </div><!-- end .bl1page-info -->
            <div class="bl1page-more"><a href="' . get_permalink() . '" rel="bookmark">Read more</a></div>
         </div><!-- end .bl1page-col -->';
    endwhile;
